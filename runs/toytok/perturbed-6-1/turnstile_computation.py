...
# plot_contour(0, ax)
# ax.scatter(
#     results[0][0], results[0][2], marker="X", color="tab:orange", edgecolors="black", linewidths=1, zorder=11
# )
# for ff in range(1,6):
#     plot_contour(ff, ax)
...
# fig.savefig(saving_folder / f"coutour_fwd.png", dpi=300, bbox_inches='tight', pad_inches=0.1)
# fig.savefig(saving_folder / f"coutour_fwd.pdf", dpi=300, bbox_inches='tight', pad_inches=0.1)
...
# plot_contour(-1, ax)
# plot_contour(6, ax)
# xlims = ax.set_xlim(6.15, 6.29)
# ylims = ax.set_ylim(-4.53, -4.41)
# fig.savefig(saving_folder / f"coutour_c2.png", dpi=300, bbox_inches='tight', pad_inches=0.1)
# fig.savefig(saving_folder / f"coutour_c2.pdf", dpi=300, bbox_inches='tight', pad_inches=0.1)
...
# ax.set_xlim(5.4, 7.4)
# ax.set_ylim(-4.75, -4.75+ratio*(7.4-5.4))
# fig.savefig(saving_folder / f"coutour_c1.png", dpi=300, bbox_inches='tight', pad_inches=0.1)
# fig.savefig(saving_folder / f"coutour_c1.pdf", dpi=300, bbox_inches='tight', pad_inches=0.1)
...
# ax.plot(loop[:,0], loop[:,1], 's-', color='black', linewidth=2, markersize=4, zorder=12)
# ax.scatter(6.7913, -4.0464, color='black', label=r'$B^\phi$ evaluation point', zorder=14)
# ax.legend(loc='lower right')

# fig.savefig(saving_folder / "verification_loop.png", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
# fig.savefig(saving_folder / "verification_loop.pdf", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
...
# fig.savefig(saving_folder / "verification_triangle.png", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
# fig.savefig(saving_folder / "verification_triangle.pdf", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
...
# ## calculationg by the integral on the loop
# mid_gamma = (loop[1:] + loop[:-1])/2
# mid_gamma = np.vstack((mid_gamma[:,0], 0*np.ones(mid_gamma.shape[0]), mid_gamma[:,1])).T
# mid_A = np.array([pyoproblem.A(r)[0::2] for r in mid_gamma])
# dl = np.diff(loop, axis=0)
# print(f"Area using the integral of A on the loop approximation: {np.einsum('ij,ij->i', mid_A, np.ones((mid_A.shape[0], 1)) * dl).sum()}")