...
# # fig.savefig(saving_folder / "clinic_start_0.pdf", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
# plt.close(fig)
...
# Assuming r_end_u_i and dr are defined and contain the start point and the delta for the arrow, respectively
arrow = FancyArrowPatch(posA=r_end_u_i-1e-3, posB=(r_end_u_i[0] + dr[0], r_end_u_i[1] + dr[1]), 
                        arrowstyle='-|>', mutation_scale=20, lw=2, color='k', zorder=13)
axs[0].add_patch(arrow)
# axs[0].arrow(*r_end_u_i, *dr, head_width=0.05, head_length=0.1, fc='k', ec='k', zorder=13)

fig.savefig(saving_folder / "clinic_start.png", dpi=300, bbox_inches='tight', pad_inches=0.1)
fig.savefig(saving_folder / "clinic_start.pdf", dpi=300, bbox_inches='tight', pad_inches=0.1)
...
#     fig.savefig(saving_folder / f"homoclinic_{i}.png", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
#     fig.savefig(saving_folder / f"homoclinic_{i}.pdf", dpi=DPI, bbox_inches='tight', pad_inches=0.1)
...
# fig.savefig(saving_folder / "clinic_search_contour.pdf", bbox_inches='tight', pad_inches=0.1)