...
fig.savefig(saving_folder / "manifold.png", dpi=300, bbox_inches='tight', pad_inches=0.1)
...
fig.savefig(saving_folder / "clinic0.png", dpi=300, bbox_inches='tight', pad_inches=0.1)