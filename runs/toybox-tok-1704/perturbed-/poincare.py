...
if __name__ == "__main__":
    ...
    maxwellboltzmann = {"m": 5, "n": -2, "d": np.sqrt(2), "type": "maxwell-boltzmann", "amplitude": 1e-5}
    ...
    # n1, n2 = int(np.ceil(2*nfieldlines / 3)), int(np.floor(nfieldlines / 3))
    frac_n1 = 3/4
    n1, n2 = int(np.ceil(frac_n1 * nfieldlines)), int(np.floor((1 - frac_n1) * nfieldlines))
