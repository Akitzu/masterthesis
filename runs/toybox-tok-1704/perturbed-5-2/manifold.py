...
if __name__ == "__main__":
    ...
    maxwellboltzmann = {"m": 5, "n": -2, "d": 0.8, "type": "maxwell-boltzmann", "amplitude": 1e-1}
    ...
    fp.compute(guess=guess, pp=0, qq=1, sbegin=4, send=9, tol=1e-10)
    ...
    if args.compute_poincare:
        ...
        fig = pickle.load(open("poincare_04171427.pkl", "rb"))
        ax = fig.gca()
    ...
    manifold.compute(nintersect = 6, neps = 300, epsilon=1e-6, directions="u+")
    manifold.compute(nintersect = 3, neps = 300, epsilon=1e-6, directions="u-")
    manifold.compute(nintersect = 6, neps = 100, epsilon=1e-6, directions="s+")
    manifold.compute(nintersect = 3, neps = 100, epsilon=1e-6, directions="s-")
