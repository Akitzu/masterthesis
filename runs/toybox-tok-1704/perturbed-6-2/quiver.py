...
if __name__ == "__main__":
    ...
    maxwellboltzmann = {"m": 6, "n": -2, "d": np.sqrt(2), "type": "maxwell-boltzmann", "amplitude": 1e-3}
    ...
    pyoproblem.plot_intensities(ax = ax, rw=[3.5, 9.2], zw=[-6, 2.2], nl=[200, 200], RZ_manifold = RZ_manifold, N_levels=50, alpha = 0.5)
